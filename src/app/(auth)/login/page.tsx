...
import { PenTool, Eye, EyeOff, ArrowRight, GitBranch, Mail } from 'lucide-react'
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <p className="text-center text-sm text-slate-500 mt-6">
              ...
              <Link href="/register" className="text-blue-600 hover:text-blue-700 font-medium">Start for free</Link>
            </p>
          </div>
