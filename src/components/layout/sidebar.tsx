...
import {
  ...
  PenTool, Users, Zap, ChevronDown, Plus, Search, Bell, X
} from 'lucide-react'
      ...
      <div className="px-4 py-3 border-b border-slate-100">
        <button className="w-full flex items-center gap-2.5 px-2 py-2 rounded-lg hover:bg-slate-50 transition-colors text-left">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-slate-800 truncate">{user.workspace}</p>
...
export function TopBar({ title, actions }: { title?: string; actions?: React.ReactNode }) {
  return (
    <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-sm border-b border-slate-200 px-6 py-3.5">
